...
public class AssetCollectorBySemaphore implements Callable<Set<String>>{
	...
	public AssetCollectorBySemaphore(Semaphore semaphore, String IP, String ports,Set<String> ipports) {
		this.semaphore = semaphore;
		this.IP = IP;
		this.ports = ports;
		this.ipports = ipports;
	...
	public static void main(String [] args) {
		...
		String startIP = "192.168.0.1";
 		...
 		for(String ip : list) {
 			future = threadPool.submit(new AssetCollectorBySemaphore(semaphore, ip, ports1,ipports));
 		}
