...
public class AssetIpPortCollector implements Callable<Set<String>>{
	...
	public AssetIpPortCollector(Semaphore semaphore, String IP, String ports,Set<String> ipports ,String filepath,String pak) {
		this.semaphore = semaphore;
		this.IP = IP;
		this.ports = ports;
		this.ipports = ipports;
...
// 		System.out.println(list);
 		...
 		for(String port:ports){
 			for(String ip : list) {
 	 			future = threadPool.submit(new AssetIpPortCollector(semaphore, ip, port,ipports,filepath,pak));
 	 		}
 		}
